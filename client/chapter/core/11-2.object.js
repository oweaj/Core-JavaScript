...
let copyObject = Object.assign({}, messenger);
...
// 3. 전개 연산자(...)를 사용한 복사  -- 진짜 많이 쓰임
let spreadObject = { ...messenger };
console.log(spreadObject);

// 4. 객체를 복사해주는 유틸 함수
let cpObject = (object) => Object.assign({}, object);
...
// 병합하는 객체 동일한 값이 있을경우 뒤에 객체가 우선순위가 높아 적용됨  ex) 위에서는 color
...
copyedContainerStyles["max-width"].md = 999; // 기존 값도 바뀜
...
let copyDeep = cloneDeep(containerStyles);
